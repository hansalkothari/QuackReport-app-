...
public class EarthquackAdapter extends ArrayAdapter<Earthquack> {
    ...
    public EarthquackAdapter(@NonNull Context context, @NonNull List<Earthquack> Earthquackes) {
        super(context,0, Earthquackes);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Earthquack currentEarthquack = getItem(position);
        ...
        int magnitudeColor;
        magnitudeColor = getMagnitudeColor(currentEarthquack.getMagnitude());
        ...
        Date dateObject = new Date(currentEarthquack.getTimeInMilliseconds());
